...
const CATEGORIES: {
  ...
  { code: 'conversation_coffee',    icon: '/categories/coffee.png',     en: { title: 'Coffee & talk',       desc: 'Cafés, deep conversations' },     ko: { title: '커피와 대화',      desc: '카페, 깊은 이야기' } },
  { code: 'board_games_casual',     icon: '/categories/game.png',       en: { title: 'Games & fun',         desc: 'Board games, mafia, cards' },     ko: { title: '보드게임 · 놀이',  desc: '보드게임, 마피아, 카드' } },
  { code: 'workshops_creative',     icon: '/categories/makethings.png', en: { title: 'Make something',      desc: 'Pottery, baking, crafts' },       ko: { title: '함께 만들기',      desc: '도자기, 베이킹, 공예' } },
  { code: 'active_outdoor',         icon: '/categories/adventure.png',  en: { title: 'Outdoors',            desc: 'Hikes, walks, easy trails' },     ko: { title: '바깥으로',         desc: '등산, 산책, 트레킹' } },
  { code: 'food_dining',            icon: '/categories/food.png',       en: { title: 'Food & dining',       desc: 'Restaurants, tastings' },         ko: { title: '맛집 · 식사',      desc: '동네 맛집, 푸드 투어' } },
  { code: 'learning_culture',       icon: '/categories/books.png',      en: { title: 'Learning & culture',  desc: 'Bookshops, museums, talks' },     ko: { title: '배움 · 문화',      desc: '서점, 박물관, 강연' } },
  { code: 'nature_calm',            icon: '/categories/nature.png',     en: { title: 'Nature & calm',       desc: 'Parks, gardens, slow walks' },    ko: { title: '자연 · 산책',      desc: '공원, 정원, 느긋한 산책' } },
  { code: 'escape_puzzles',         icon: '/categories/puzzle.png',     en: { title: 'Escape & puzzles',    desc: 'Escape rooms, mystery games' },   ko: { title: '방탈출 · 퍼즐',    desc: '방탈출, 퍼즐 카페' } },
  { code: 'movies_music_shows',     icon: '/categories/movie.png',      en: { title: 'Movies & shows',      desc: 'Cinema, concerts, exhibits' },    ko: { title: '영화 · 공연',      desc: '영화관, 콘서트, 전시' } },
  { code: 'career_networking',      icon: '/categories/network.png',    en: { title: 'Career & networking', desc: 'Meetups, tech talks' },           ko: { title: '커리어 · 네트워킹', desc: '밋업, 테크 토크' } },
  { code: 'volunteering_community', icon: '/categories/help.png',       en: { title: 'Volunteering',        desc: 'Community events, giving back' }, ko: { title: '봉사 · 커뮤니티',  desc: '봉사 활동, 커뮤니티' } },
  { code: 'nightlife_social',       icon: '/categories/nightout.png',   en: { title: 'Nightlife',           desc: 'Bars, night markets, hangouts' }, ko: { title: '나이트라이프',     desc: '바, 야시장, 저녁 모임' } },
];
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            ...
            >
              ...
              <img src={cat.icon} alt="" className="cat-icon" />
      ...
      <style jsx>{`
        ...
        .interest-card .cat-icon { width: 44px; height: 44px; object-fit: contain; margin-bottom: 6px; display: block; }
