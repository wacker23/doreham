      ...
      <main id="top">
        ...
        <section className="venue-cta">
          ...
          <style jsx>{`
            ...
            .cta-icon { width: 140px; height: 140px; object-fit: contain; margin: 0 auto 16px; display: block; } .scene-ic { width: 56px; height: 56px; object-fit: contain; margin-bottom: 8px; display: block; }
