      ...
      <main id="top">
        ...
        <section className="venue-cta">
          ...
          <style jsx>{`
            ...
            .cta-icon { width: 340px; height: 340px; object-fit: contain; display: block; margin: 0 auto -70px; } .scene-ic { width: 56px; height: 56px; object-fit: contain; margin-bottom: 8px; display: block; }
